...
ENLACE_POWERBI = "https://colaboraage.sharepoint.com/:u:/s/SGAMET-Teams/IQAv1q3kZXDUTJwxG9jDiVchAakGj9wLQ60CjtT6FbQxoyk?e=89LiCS"
...
if not st.session_state.acceso_ok:
    ...
    st.markdown(f"""
        <div class="tarjeta">
            ...
            <hr class="separador"/>
            <p class="titulo-principal">Cuadro de Mandos · Operadoras</p>
